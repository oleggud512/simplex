...
#     b_vector: list[float]  # вектор лівої частини обмежень
#     a_rules: list[list[float]]  # коефіцієнти правої частини обмежень
#     c_values: list[float]  # цільова функція
#     c_base_vector: list[float]

#     def __init__(self, rules_count: int, arguments_count: int):
#         assert(rules_count != None and 
#                rules_count > 1 and 
#                arguments_count != None and 
#                arguments_count > 1) 
